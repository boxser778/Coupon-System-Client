...
import { dateStringToNumber } from "./../app/Utils/dateUtilConvertor";
...
export class CompanysService {
  ...
  public getCompanyById(companyid: number): Observable<Company> {
    return this.httpClient.get<Company>(
      `${COMPANY_SERVER_URL}/company/${companyid}`
    );
  }
  ...
  // public getCouponByEndDate(
  //   companyid: number,
  //   endDate: string
  // ): Observable<Coupon[]> {
  //   const endDateAsNumber = dateStringToNumber(endDate);
  //   return this.httpClient.get<Coupon[]>(
  //     `${COMPANY_SERVER_URL}/couponbyenddate/${companyid}/${endDateAsNumber}`
  //   );
  // }
  ...
  public getCouponByPrice(
    companyid: number,
    price: number
  ): Observable<Coupon[]> {
    return this.httpClient.get<Coupon[]>(
      `${COMPANY_SERVER_URL}/couponbyprice/${companyid}/${price}`
    );
  }
  ...
  public getCouponByType(
    ...
    return this.httpClient.get<Coupon[]>(
      `${COMPANY_SERVER_URL}/couponbytype/${companyid}/${type}`
    );
  }
  ...
  public getAllCompanyIncome(companyid: number): Observable<Income[]> {
    return this.httpClient.get<Income[]>(
      `${COMPANY_SERVER_URL}/allincomecompany/${companyid}`
    );
  }
}
